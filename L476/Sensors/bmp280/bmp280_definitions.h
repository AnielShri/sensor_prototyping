...
typedef enum
{
	...
	BMP280_TEMPERATURE_OVERSAMPLING_1X = (0b001 << 5),
	BMP280_TEMPERATURE_OVERSAMPLING_2X = (0b010 << 5),
	BMP280_TEMPERATURE_OVERSAMPLING_4X = (0b011 << 5),
	BMP280_TEMPERATURE_OVERSAMPLING_8X = (0b100 << 5),
	BMP280_TEMPERATURE_OVERSAMPLING_16X = (0b101 << 5),
...
}bmp280_filter_coefficient_enum;
